...
export const GENERAL_MENU=[
  ...
  {id:'planificacion',label:'Planificación',items:[
    panel('oferta','Oferta y materias',[tab('dictado','Oferta del cuatrimestre','cátedras que se dictan apertura'),tab('catedras','Materias y asignaciones','cátedras'),tab('decisiones','Decisiones de apertura','toma de decisiones')]),
